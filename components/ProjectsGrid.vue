...
import { useProjectStore } from '~/stores/myStore';
...
export default defineComponent({
  setup() {
    ...
    return {
      projectsHeading: store.projectsHeading,
      projectsDescription: store.projectsDescription,
...
<div class="pt-10 sm:pt-20 md:pt-24">
    ...
    <div class="mt-8 sm:mt-10">
        <h3 class="
          ...
          mb-4
        ">
            Rechercher par titre ou filtrer par catégorie
        </h3>
        <div class="
          flex
          justify-between
